...
import GooglePlacesTest from './test/GooglePlacesTest';
import ImagePickerTest from './test/ImagePickerTest';
import LocalizationTest from './test/LocalizationTest';

export function registerScreens() {
  // Component Test
  Navigation.registerComponent('Healer.MapTest', () => MapTest);
  Navigation.registerComponent('Healer.FirebaseTest', () => FirebaseTest);
  Navigation.registerComponent('Healer.VideoTest', () => VideoTest);
  Navigation.registerComponent('Healer.GooglePlacesTest', () => GooglePlacesTest);
  Navigation.registerComponent('Healer.ImagePickerTest', () => ImagePickerTest);
  Navigation.registerComponent('Healer.LocalizationTest', () => LocalizationTest);
